      ...
      <div className="container m-auto">
        <div className="flex flex-row  justify-between items-start ">
          <div>
            ...
            <div className=" border bg-transparent rounded-lg border-gray-500 flex flex-row-reverse sm:flex-row justify-start items-center space-x-1 p-4 ">
              <div>
              ...
              <div className="flex flex-col h-auto justify-between items-start">
                ...
                <div className="mt-4">
                  <Button variant="simple" className=" p-0">
                    Signup
                  </Button>
                </div>
              </div>
